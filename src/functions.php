...
if (!function_exists('stringToInt')) {
     ...
     */
    function stringToInt(string|int $value, ?NumberSign $sign = null, bool $strictType = true, bool $acceptsZero = true): int
    {
        return SmartCast::stringToInt($value, $sign, $strictType, $acceptsZero);
    }
}
...
if (!function_exists('stringToFloat')) {
     ...
     */
    function stringToFloat(string|float $value, ?NumberSign $sign = null, bool $strictType = false, bool $acceptsZero = true): float
    {
        return SmartCast::stringToFloat($value, $sign, $strictType, $acceptsZero);
    }
}
